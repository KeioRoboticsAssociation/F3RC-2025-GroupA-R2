...
ServoMotor::ServoMotor(PinName pwm_pin, chrono::microseconds min_pulse_width, chrono::microseconds max_pulse_width, chrono::milliseconds pwm_period)
...
void ServoMotor::setPulseWidth(chrono::microseconds pulse_width)
{
