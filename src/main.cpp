...
int main()
{
    ...
    Encoder encoder5(InterruptInPins::MEASURING_ENCODER2_A, DigitalInPins::MEASURING_ENCODER2_B);
    ...
    OdomWheel<5> odom_wheel(PIDGain{1, 0, 0, 100}, config, motor_controller, encoders);
