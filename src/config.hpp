...
{
    constexpr PinName OMNI_MOTOR1_DIR   = PB_10;     // オムニホイールDC1の方向
    constexpr PinName OMNI_MOTOR2_DIR   = PC_7 ;     // オムニホイールDC2の方向
    constexpr PinName OMNI_MOTOR3_DIR   = PB_4 ;     // オムニホイールDC3の方向
    constexpr PinName OMNI_DUMMY_DIR    = PB_4 ;     // 測定輪用のダミー
...
{
    constexpr PinName OMNI_MOTOR1_PWM   = PA_8 ;     // オムニホイールDC1のPWM (Tim1)
    constexpr PinName OMNI_MOTOR2_PWM   = PA_9 ;     // オムニホイールDC2のPWM (Tim1)
    constexpr PinName OMNI_MOTOR3_PWM   = PA_10;     // オムニホイールDC3のPWM (Tim1)
    constexpr PinName OMNI_DUMMY_PWM    = PA_10;     // 測定輪用のダミー
...
namespace InterruptInPins
{
    ...
    constexpr PinName OMNI_ENCODER1_A           = PC_2 ;     // エンコーダー3：オムニ用エンコーダー1のA相
    constexpr PinName OMNI_ENCODER2_A           = PC_0 ;     // エンコーダー4：オムニ用エンコーダー2のA相
    constexpr PinName OMNI_ENCODER3_A           = PC_9 ;     // エンコーダー5：オムニ用エンコーダー3のA相
...
namespace DigitalInPins
{
    ...
    constexpr PinName OMNI_ENCODER1_B           = PC_3 ;     // エンコーダー3：オムニ用エンコーダー1のB相
    constexpr PinName OMNI_ENCODER2_B           = PC_1 ;     // エンコーダー4：オムニ用エンコーダー2のB相
    constexpr PinName OMNI_ENCODER3_B           = PB_8 ;     // エンコーダー5：オムニ用エンコーダー3のB相
